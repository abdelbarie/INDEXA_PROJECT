const ProductsData = [
  ...
  {
    id: 1,
    productName: "كوباريتم ـ العلبة الحسابية",
    description:
  ...
  {
    id: 5,
    productName: "مدور ذات النقطة الجافة",
  ...
  {
    id: 7,
    productName: "مسطرة بلاستيكية 30 سم",
  ...
  {
    id: 10,
    productName: "عصا المكفوفين قابلة للطي ",
  ...
  {
    id: 18,
    productName: "لعبة الدومينو الخشبية للمكفوفين",
  ...
  {
    id: 19,
    productName: "لعبة الذاكرة باللمس",
  ...
  {
    id: 21,
    productName: " برنامج  لنظام التشغيل ويندوز",
  ...
  {
    id: 33,
    productName: "لعبة الغاز الأرقام",
    description: "مصنوع من الخشب بمكان مخصص لكل رقم",
  ...
  {
    id: 35,
    productName: "لعبة الغاز الحروف الكبيرة",
  ...
  {
    id: 36,
    productName: "مسطرة مكبرة X 2، مع خط توجيهي",
  ...
  {
    id: 39,
    productName: "مثبت الإشارات التاجي",
    description:
  ...
  {
    id: 40,
    productName: "ماسح النقاط",
    description:
      "ملحق خشبي يسمح لك بمسح نقطة ما بفضل نهايته الرفيعة، أو حرف واحد أو أكثر من ذلك باستخدام نهايته المسطحة.",
    longDescription: `
    ملحق خشبي يسمح لك بمسح نقطة ما بفضل نهايته الرفيعة، أو حرف واحد أو أكثر من ذلك باستخدام نهايته المسطحة..`,
    details: `
    - الطول: 7.8 سم
    - قطر اوسع جزء: 2.1 سم
    - قطر أنحف جزء: 0.15 سم
    - الوزن: 15 غرام
  ...
  },
  {
    ...
    صناديق الإطار كل منها مزودة بـ 6 فتحات تسهل الكتابة بمثبت الإشارات.
     يتم توفير فتحات في نهايات الخطين 9 و17 لمرور شرائط لاصقة مقاسها ما بين 9 و12 مم.
    أبعاد اللوحة (عرض × طول × سماكة): 19 × 30 × 0.5 سم.
    الوزن: 285 غرام.
